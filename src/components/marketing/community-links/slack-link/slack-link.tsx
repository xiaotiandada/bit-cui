...
import {
  CommunityLink,
  PrimaryLinkProps
} from "@waweb/evangelist.marketing.community-links.community-link"
import { Icon } from "@waweb/evangelist.elements.icon"
...
export function SlackLink({ className, children, ...rest }: SlackLinkProps) {
  return (
    <CommunityLink
      external
      data-bit-id="waweb.evangelistarketing/community-links/slack-link"
