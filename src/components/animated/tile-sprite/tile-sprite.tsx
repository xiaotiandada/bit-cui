...
const cat = 'https://storageapi.fleek.co/xiaotiandada-team-bucket/assets/images/cat.png'
const clouds = 'https://storageapi.fleek.co/xiaotiandada-team-bucket/assets/images/clouds.png'
const bg = 'https://storageapi.fleek.co/xiaotiandada-team-bucket/assets/images/bg.png'
const ground = 'https://storageapi.fleek.co/xiaotiandada-team-bucket/assets/images/ground.png'
const player = 'https://storageapi.fleek.co/xiaotiandada-team-bucket/assets/images/player.png'


export type TileSpriteProps = {
  /**
...
export function TileSprite({ text }: TileSpriteProps) {
  const load = () => {
